 ...
 *
 * A car fleet is a non-empty set of cars driving at the same position and same speed. A single
 * car is also considered a car fleet.
 *
 * If a car catches up to a car fleet the moment the fleet reaches the destination, then the car
 ...
 * // Output: 1
 * // Explanation: The cars starting at 1 (speed 3) and 4 (speed 2) become a fleet, meeting each
 * // other at 10, the destination.
 *
 * @example
 * // Example 2:
 * // Input: target = 10, position = [4,1,0,7], speed = [2,2,1,1]
 * // Output: 3
 * // Explanation: The cars starting at 4 and 7 become a fleet at position 10. The cars starting
 * // at 1 and 0 never catch up to the car ahead of them. Thus, there are 3 car fleets that will

...
// Test SolutionSorting
console.log('\nTesting SolutionSorting (sorting approach):\n');
const solutionSorting = new SolutionSorting();
passed = 0;
failed = 0;
...
const sortingPassed = passed;
const sortingFailed = failed;

// Summary for SolutionSorting
console.log(`\n${'='.repeat(50)}`);
console.log(`SolutionSorting Tests Passed: ${sortingPassed}/${sortingPassed + sortingFailed}`);
console.log(`SolutionSorting Tests Failed: ${sortingFailed}/${sortingPassed + sortingFailed}`);

// Overall Summary
const totalPassed = frequencyMapPassed + sortingPassed;
const totalFailed = frequencyMapFailed + sortingFailed;
console.log(`\n${'='.repeat(50)}`);
